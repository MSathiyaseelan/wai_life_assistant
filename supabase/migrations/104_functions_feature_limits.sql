-- Migration 104: Add 'my_function' / 'upcoming_function' / 'attended_function'
-- to the shared feature-limit resolver.
--
-- plan_limits.functions_my_max (5), functions_upcoming_max (15), and
-- functions_attended_max (30) have existed since 054_subscription_system.sql
-- but were never enforced anywhere — MyHub/FamilyHub Functions had no cap on
-- any plan. Standing count caps (like pantry_recipes_max), not monthly usage
-- counters — removing/deleting one frees up a slot for another.
