            ...
            child: ListView(
              ...
              children: [
                ...
                _section(
                  ...
                  [
                    _para(
                      'We collect only the personal data you choose to enter into the app:',
                    ),
                    _bullet('Identity: Name, date of birth'),
                    _bullet(
                      'Contact: Mobile phone number (used for OTP login)',
                    ),
                    _bullet(
                      'Financial: Income, expenses, wallets, budgets you record',
                    ),
                    _bullet(
                      'Lifestyle: Health notes, pantry items, tasks, reminders, wardrobe entries, wishes',
                    ),
                    _bullet(
                ...
                _section(
                  ...
                  [
                    ...
                    _bullet(
                      'Storing and displaying your personal records across devices',
                    ),
                    _bullet('Sending reminders and alerts you create'),
                    _bullet(
                      'Running AI parsing on data you explicitly submit (e.g., bill scan, SMS parser)',
                    ),
                    _para(
                ...
                _section(
                  ...
                  [
                    _para(
                      'Your data is stored in Supabase (hosted on AWS ap-south-1 — Mumbai region). All data is:',
                    ),
                    _bullet('Encrypted in transit (TLS 1.3)'),
                    _bullet('Encrypted at rest (AES-256)'),
                    _bullet(
                      'Access-controlled by Row Level Security — only you can read your records',
                    ),
                    _bullet(
                      'Locally cached credentials are stored in encrypted storage (Android Keystore / iOS Secure Enclave)',
                    ),
                  ],
                ),
                _section(
                  ...
                  [
                    ...
                    _bullet(
                      'Right to Access: View all data we hold about you (use Export My Data in Privacy & Security settings)',
                    ),
                    _bullet(
                ...
                _section(
                  ...
                  [
                    ...
                    _bullet(
                      'All your personal records are immediately soft-deleted',
                    ),
                    _bullet('Hard deletion completes within 30 days'),
                    _bullet(
                      'Anonymised aggregate statistics (no personal identifiers) may be retained for service improvement',
                    ),
                    _para(
                      'Deleted items in the Recycle Bin are permanently purged after 30 days.',
                    ),
                  ],
                ),
                _section(
                  ...
                  [
                    ...
                    _bullet(
                      'Supabase — Database, storage, and edge functions. Privacy policy: supabase.com/privacy',
                    ),
                    _bullet(
                ...
                _section(
                  ...
                  [
                    _para(
                      'We may update this policy from time to time. Material changes will be notified in-app. Continued use of the app after notification constitutes acceptance of the updated policy.',
                    ),
                  ],
                ),
                _section(
                  ...
                  [
                    _para(
                      'As required under the DPDP Act, you may contact our Grievance Officer for any data-related concerns:',
                    ),
                    _para(
                      'Email: riyasailabs@gmail.com\nResponse time: Within 7 business days',
                    ),
                    _para(
                      'To exercise your right to erasure, use the "Delete My Account" option in Privacy & Security settings, or contact us at the above email.',
                    ),
                  ],
                ),
              ],
