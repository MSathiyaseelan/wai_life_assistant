...
const _kTables = [
  ('wishes',                  'PlanIt',   ['title', 'name']),
  ('reminders',               'PlanIt',   ['title', 'name']),
  ('notes',                   'Notes',    ['title', 'content', 'description']),
  ('wardrobe_items',          'Wardrobe', ['name', 'category', 'description']),
  ('health_medications',      'Health',   ['name', 'description']),
  ('health_doctors',          'Health',   ['name', 'description']),
  ('health_documents',        'Health',   ['title', 'name', 'description']),
  ('health_appointments',     'Health',   ['title', 'doctor_name', 'description']),
  ('health_vitals',           'Health',   ['name', 'type', 'description']),
  ('health_vaccinations',     'Health',   ['vaccine_name', 'name', 'description']),
  ('health_insurance',        'Health',   ['provider', 'name', 'description']),
  ('family_members',          'Family',   ['name', 'description']),
  ('functions_my',            'Functions',['title', 'name', 'description']),
  ('functions_upcoming',      'Functions',['title', 'name', 'description']),
  ('functions_attended',      'Functions',['title', 'name', 'description']),
  ('function_participants',   'Functions',['name', 'description']),
  ('function_moi_entries',    'Functions',['name', 'description', 'title']),
  ('function_clothing_families','Functions',['family_name', 'name', 'description']),
  ('function_bridal_essentials','Functions',['item_name', 'name', 'description']),
  ('function_return_gifts',   'Functions',['item_name', 'name', 'description']),
  ('item_locator_containers', 'Locator',  ['name', 'description']),
  ('item_locator_items',      'Locator',  ['name', 'description']),
  ('tx_groups',               'Wallet',   ['name', 'description']),
  ('bills',                   'Wallet',   ['name', 'category', 'description']),
  ('wallet_budgets',          'Wallet',   ['category', 'name', 'description']),
  ('recipes',                 'Pantry',   ['name', 'description']),
  ('meal_entries',            'Pantry',   ['name', 'description']),
  ('meal_reactions',          'Pantry',   ['comment', 'member_name', 'description']),
];
