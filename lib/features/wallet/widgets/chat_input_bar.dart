...
class _ChatInputBarState extends State<ChatInputBar>
  ...
  void initState() {
    ...
    _micScale = Tween(begin: 1.0, end: 1.2).animate(
  ...
  Widget build(BuildContext context) {
    ...
    final hintColor = isDark ? const Color(0xFF6E6E90) : const Color(0xFF8E8EA0);
          ...
          Expanded(
            child: AnimatedContainer(
              ...
              child: TextField(
                ...
                style: TextStyle(
                  fontSize: 14, color: textColor, fontFamily: 'Nunito'),
                decoration: InputDecoration.collapsed(
                  hintText: 'Tell me what happened... (e.g. "spent 500 on food")',
                  hintStyle: TextStyle(
                    fontSize: 13, color: hintColor, fontFamily: 'Nunito'),
                ),
