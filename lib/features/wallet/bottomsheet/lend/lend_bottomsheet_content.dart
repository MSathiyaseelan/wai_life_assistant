...
class LendFormContent extends StatefulWidget {
  ...
  @override
  State<LendFormContent> createState() => _LendFormContentState();
}

class _LendFormContentState extends State<LendFormContent> {
      ...
      builder: (_, __) {
        return Form(
          ...
          child: Column(
            ...
            children: [
              Text('Add Lend', style: textTheme.titleMedium),
